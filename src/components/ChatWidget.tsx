  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      role: "assistant",
      content:
        "Hello! I am Gilbert's AI Assistant. Ask me anything about his technical projects, full-stack architecture, experience, or tech stack!",
    },
  ]);
    ...
    try {
      ...
      setMessages((prev) => [
        ...prev,
        {
          ...
          content:
            data.reply ||
            "I could not generate a response right now. Please feel free to reach out to Gilbert on GitHub at https://github.com/YourGbDev!",
        },
      ]);
    } catch {
      setMessages((prev) => [
        ...prev,
        {
          role: "assistant",
          content:
            "Sorry, I am having trouble connecting right now. Please feel free to reach out to Gilbert on GitHub at https://github.com/YourGbDev!",
        },
      ]);
    } finally {
      setIsLoading(false);
