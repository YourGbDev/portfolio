      ...
      >
        ...
        >
          ...
          <div className="space-y-2">
            {memberOf.map((member) => {
              const isLink = member.href && member.href !== "#" && member.href.length > 0;
              if (isLink) {
                return (
                  <a
                    key={member.name}
              ...
              return (
                <div
                  key={member.name}
                  className="flex items-center justify-between py-2 px-1 rounded border-b border-border-hairline/40 last:border-b-0"
                >
                  <span className="font-sans text-xs sm:text-[13px] text-muted-foreground line-clamp-1">
                    {member.name}
                  </span>
                </div>
              );
        ...
        {/* Column 3: Collaboration / Inquiries */}
        <motion.div
          variants={shouldReduceMotion ? undefined : gridItemVariants}
          className="space-y-3"
        >
          ...
          <p className="font-sans text-xs sm:text-[13px] text-muted-foreground leading-relaxed">
            Open to junior roles, internships, and freelance collaboration. Reach out through GitHub to discuss ideas, projects, or opportunities.
          </p>
