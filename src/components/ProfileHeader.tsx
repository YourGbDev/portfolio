...
export function ProfileHeader() {
  ...
  // Preload hover avatar for smooth caching
  useEffect(() => {
  ...
  // Lighting reveal animation on hover/interaction
  useEffect(() => {
    ...
    <section className="w-full select-none mb-16">
      ...
      <div className="flex items-start gap-4 sm:gap-5">
        ...
        >
          ...
          {/* Hover Lighting Overlay (same avatar, preserving lighting reveal animation) */}
          {/* eslint-disable-next-line @next/next/no-img-element */}
          <img
            src="/images/avatar.jpg"
            alt="Profile Lighting Overlay"
            className="absolute inset-0 w-full h-full object-cover z-10 pointer-events-none transition-[opacity,filter] duration-300"
            style={{
              objectPosition: "center 25%",
              opacity: animationFrame > 0 ? animationFrame / 240 : 0,
              filter: `brightness(${1 + animationFrame / 2400})`,
            }}
          />
        </div>
      ...
      <div className="flex items-center flex-wrap gap-2.5 mt-5 pt-1">
        ...
        {/* Send Email */}
        <a
          href="mailto:iskaderbay@gmail.com"
          className="tactile-btn gap-1.5"
        >
