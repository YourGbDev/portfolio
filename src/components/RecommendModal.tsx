...
export function RecommendModal({ isOpen, onClose }: RecommendModalProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!relationship) {
      setError("Please select how you know Gilbert.");
      return;
    }
        ...
        <div className="flex items-start justify-between gap-4 border-b border-border-hairline/40 pb-3.5">
          <div className="space-y-1">
            ...
            <p className="font-sans text-xs text-muted-foreground leading-relaxed">
              Share your experience working, collaborating, or learning with Gilbert. Submissions are moderated before publishing.
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="space-y-1.5">
              ...
              >
                <option value="" disabled>
                  Select your relationship with Gilbert
                </option>
            ...
            <div className="space-y-1.5">
              ...
              <textarea
                ...
                maxLength={1000}
                rows={4}
                placeholder="What was your experience working with Gilbert? (min 20 characters)"
            ...
            <div className="pt-1">
              <label className="flex items-start gap-2.5 cursor-pointer select-none">
                ...
                <span className="font-sans text-xs text-muted-foreground leading-snug">
                  I&rsquo;m okay with this recommendation being displayed publicly on Gilbert&rsquo;s portfolio.
                </span>
              </label>
            </div>
